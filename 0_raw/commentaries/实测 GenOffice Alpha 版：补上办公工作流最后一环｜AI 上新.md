...
source_account: 极客公园
source_url: https://mp.weixin.qq.com/s/OvWb9PRW-Whqkg2pM1mlFw
...
总结而言，GenOffice 目前展现出来的格式批量编辑能力已经足够实用。只要用户能整理好格式需求，GenOffice 就能调动模型强大的泛化能力，连接自身扎实的转换层工具，将内容转换为可交付级的文档，补上 AI 办公工作流的最后一环。
03
PPT 生成靠模版
